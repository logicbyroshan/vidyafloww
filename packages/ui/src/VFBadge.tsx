...
const badgeVariants = cva(
  "inline-flex items-center justify-center h-6 px-2.5 text-xs font-bold tracking-normal transition-colors select-none rounded-md leading-none whitespace-nowrap",
  {
    variants: {
      variant: {
