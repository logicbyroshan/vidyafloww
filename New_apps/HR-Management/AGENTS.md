# AGENTS.md — Agent Operating Guide: Operational HR & Staff Management

Guidelines for AI coding agents developing inside **Operational HR & Staff Management** (`HR-Management`).
