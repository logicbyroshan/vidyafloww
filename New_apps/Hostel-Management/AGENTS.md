# AGENTS.md — Agent Operating Guide: Hostel & Dormitory Management

Guidelines for AI coding agents developing inside **Hostel & Dormitory Management** (`Hostel-Management`).
