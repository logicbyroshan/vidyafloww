# AGENTS.md — Agent Operating Guide: Digital E-Library & Reading Hub

Guidelines for AI coding agents developing inside **Digital E-Library & Reading Hub** (`Library-Management`).
