...
const NAVIGATION_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'fees', label: 'Fees & Finance', route: '/fees', icon: CircleDollarSign },
      { id: 'documents', label: 'Documents & Certificates', route: '/documents', icon: FileCheck2 },
      { id: 'library', label: 'Library', route: '/library', icon: BookOpen },
      { id: 'transport', label: 'Transport', route: '/transport', icon: Bus },
      { id: 'hostel', label: 'Hostel', route: '/hostel', icon: Building2 },
      { id: 'inventory', label: 'Inventory', route: '/inventory', icon: Package },
      { id: 'assets', label: 'Assets & Maintenance', route: '/administration', icon: Wrench },
    ],
  },
  {
    title: 'PEOPLE',
    items: [
      { id: 'hr', label: 'Staff & HR', route: '/hr', icon: Briefcase },
      { id: 'health', label: 'Student Health', route: '/health', icon: Stethoscope },
      { id: 'counselling', label: 'Counselling & Support', route: '/welfare', icon: Brain },
    ],
  },
  {
    title: 'ENGAGEMENT',
    items: [
      { id: 'communication', label: 'Communication', route: '/communication', icon: Megaphone },
      { id: 'events', label: 'Events & Calendar', route: '/events', icon: Sparkles },
      { id: 'activities', label: 'Student Activities', route: '/activities', icon: Trophy },
      { id: 'surveys', label: 'Surveys & Forms', route: '/forms', icon: ClipboardCheck },
      { id: 'complaints', label: 'Complaints & Grievances', route: '/grievances', icon: HeartHandshake },
      { id: 'front-office', label: 'Front Office', route: '/front-office', icon: UserCheck },
    ],
  },
  {
    title: 'GOVERNANCE',
    items: [
      ...
      { id: 'administration', label: 'School Administration', route: '/system', icon: Landmark },
      { id: 'compliance', label: 'Compliance & Records', route: '/compliance', icon: ShieldAlert },
      { id: 'security', label: 'Security & Audit', route: '/security', icon: ShieldCheck },
    ],
  },
  {
    title: 'SYSTEM',
    items: [
      { id: 'ai', label: 'AI Executive', route: '/ai', icon: Bot },
