...
import { VFPage, VFEmptyState } from '@vidyaflow/ui';
...
export function ErrorMaintenance() {
  return (
    <BaseErrorPage
      ...
      description="VidyaFlow is currently undergoing scheduled maintenance to improve performance and reliability. We will be back shortly."
